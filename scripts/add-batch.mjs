...
const ADDITIONS = [
  ...
  [
    'surfboard',
    'Surfboard',
    'Browsing, proxy & VPN utility for Android.',
    'https://github.com/GetSurfboard/Extensions',
  ],
  [
    'pharos',
    'Pharos',
    'Android proxy / VPN client with subscription support.',
    'https://github.com/Fndroid/clash_for_android_pkg',
  ],
  [
    'karing',
    'Karing',
    'Cross-platform proxy / VPN client (Android / iOS / desktop).',
    'https://github.com/KaringX/karing',
  ],
  [
    'clashmi',
    'Clash Mi',
    'Another Clash Meta GUI for macOS, with TUN mode.',
    'https://github.com/KaringX/clashmi',
  ],
  [
    'clashx-pro',
    'ClashX Pro',
    'Extended ClashX for macOS with rule provider support.',
    'https://github.com/SpongeNobody/Clashy',
  ],
  [
    'streisand',
    'Streisand',
    'Sets up a Shadowsocks / OpenVPN / WireGuard server in one command.',
    'https://github.com/StreisandEffect/streisand',
  ],
  [
    'clash-dashboard',
    'Clash Dashboard',
    'Web UI for Clash / Mihomo core.',
  ...
  [
    'zashboard',
    'Zashboard',
    'Modern dashboard for Mihomo / Clash Meta.',
  ...
  [
    'openconnect',
    'OpenConnect',
    'SSL VPN client, compatible with Cisco AnyConnect.',
    'https://github.com/openconnect/openconnect',
  ],
  [
    'strongswan',
    'strongSwan',
    'IPsec-based VPN solution, IKEv1/v2, IPv4/IPv6.',
    'https://github.com/strongswan/strongswan',
  ],
  [
    'libreswan',
    'Libreswan',
    'IPsec / IKE implementation for Linux.',
    'https://github.com/libreswan/libreswan',
  ],
  [
    'algo',
    'Algo',
    'Set up a personal WireGuard / IPsec VPN in the cloud.',
    'https://github.com/trailofbits/algo',
  ],
  [
    'innernet',
    'Innernet',
    'Private mesh network built on WireGuard.',
  ...
  [
    'amnezia-client',
    'AmneziaVPN',
    'Censorship-resistant VPN client with several protocols.',
    'https://github.com/amnezia-vpn/amnezia-client',
  ],
  [
    'amnezia-server',
    'Amnezia Server',
    'Server backend for AmneziaVPN.',
  ...
  [
    'pi-hole',
    'Pi-hole',
    'Network-wide ad/tracker blocking via DNS sinkhole.',
    'https://github.com/pi-hole/pi-hole',
  ],
  [
    'blocky',
    'Blocky',
    'Fast and lightweight DNS proxy with ad-blocker.',
  ...
  [
    'powerdns-recursor',
    'PowerDNS Recursor',
    'High-performance resolving DNS server.',
    'https://github.com/PowerDNS/pdns',
  ],
  [
    'knot',
    'Knot DNS',
    'Authoritative-only DNS server from CZ.NIC.',
  ...
  [
    'dnscrypt-proxy',
    'dnscrypt-proxy',
    'Flexible DNS proxy with DNSCrypt, DoH, DoT.',
    'https://github.com/DNSCrypt/dnscrypt-proxy',
  ],
  [
    'doggo',
    'doggo',
    'Modern command-line DNS client (like dig).',
  ...
  [
    'crowdsec',
    'CrowdSec',
    'Collaborative security engine, behaviour-based detection.',
  ...
  [
    'coraza',
    'Coraza',
    'Next-gen WAF, OWASP CRS compatible, written in Go.',
    'https://github.com/corazawaf/coraza',
  ],
  [
    'fail2ban',
    'Fail2ban',
    'Ban hosts that cause many authentication failures.',
    'https://github.com/fail2ban/fail2ban',
  ],
  [
    'sshguard',
    'sshguard',
    'Brute-force attack blocker for SSH and more.',
    'https://github.com/sshguard/sshguard',
  ],
  ['cowrie', 'Cowrie', 'SSH / Telnet honeypot.', 'https://github.com/cowrie/cowrie'],
  [
    'dionaea',
    'Dionaea',
    'Low-interaction honeypot that emulates services.',
  ...
  [
    'authentik',
    'Authentik',
    'Identity provider, SSO, with OIDC / SAML / LDAP.',
    'https://github.com/goauthentik/authentik',
  ],
  [
    'crowdsec-bouncer-traefik',
    'CrowdSec Traefik Bouncer',
    'CrowdSec remediation component for Traefik.',
    'https://github.com/maxlandon/crowdsec-bouncer-traefik',
  ],
  ...
  [
    'gh-proxy',
    'gh-proxy',
    'GitHub raw / release / clone proxy.',
    'https://github.com/hunshcn/gh-proxy',
  ],
  [
    'gh-proxy-go',
    'gh-proxy-go',
    'High-performance GitHub proxy written in Go.',
    'https://github.com/justloginru/gh-proxy-go',
  ],
  [
    'fastgithub',
    'FastGithub',
    'GitHub acceleration tool for Windows / macOS / Linux.',
    'https://github.com/dotnetcore/FastGithub',
  ],
  [
    'dev-sidecar',
    'DevSidecar',
    'Developer-side accelerator: GitHub / StackOverflow / npm.',
    'https://github.com/docmirror/dev-sidecar',
  ],
  [
    'watt-toolkit',
    'Watt Toolkit',
    'Steam / GitHub / Discord accelerator.',
    'https://github.com/Blinue/WattToolkit',
  ],
  [
    'cf-worker-dir',
    'CF-Worker-Dir',
    'Cloudflare Workers-based directory / file share.',
    'https://github.com/sleepybear1113/cf-worker-dir',
  ],
  ['frp', 'frp', "Fast reverse proxy to expose NAT'd services.", 'https://github.com/fatedier/frp'],
  [
    'rathole',
    'rathole',
    'Reverse proxy / tunnel similar to frp, in Rust.',
    'https://github.com/rapiz1/rathole',
  ],
  [
    'bore',
    'bore',
    'Modern, simple TCP tunnel, exposed via a public server.',
  ...
  [
    'ngrok',
    'ngrok',
    'Ingress-as-a-service: expose localhost securely.',
    'https://github.com/inconshreveable/ngrok',
  ],
  [
    'caddy',
    'Caddy',
    'Powerful HTTP/2 / HTTP/3 server with automatic HTTPS.',
  ...
  [
    'haproxy',
    'HAProxy',
    'High availability load balancer / proxy server.',
  ...
  [
    'grafana',
    'Grafana',
    'Open observability platform: metrics, logs, traces.',
  ...
  [
    'netdata',
    'Netdata',
    'Real-time performance monitoring, 1s granularity.',
    'https://github.com/netdata/netdata',
  ],
  [
    'zabbix',
    'Zabbix',
    'Enterprise-class monitoring for networks and apps.',
    'https://github.com/zabbix/zabbix',
  ],
  [
    'nagios-core',
    'Nagios Core',
    'Industry-standard network monitoring engine.',
    'https://github.com/NagiosEnterprises/nagioscore',
  ],
  [
    'checkmk',
    'Checkmk',
    'IT monitoring for infrastructures & apps.',
    'https://github.com/Checkmk/checkmk',
  ],
  [
    'victoria-metrics',
    'VictoriaMetrics',
    'Fast, cost-effective monitoring solution.',
  ...
  [
    'portainer',
    'Portainer',
    'Container management UI for Docker, Swarm, K8s.',
  ...
  [
    'casaos',
    'CasaOS',
    'Simple home cloud OS for the family.',
    'https://github.com/IceWhaleTech/CasaOS',
  ],
  [
    'umbrel',
    'Umbrel',
    'Personal home server OS for self-hosting.',
    'https://github.com/getumbrel/umbrel',
  ],
  [
    'yunohost',
    'YunoHost',
    'Self-hosting server distribution.',
    'https://github.com/YunoHost/yunohost',
  ],
  [
    'k3s',
    'K3s',
    'Lightweight Kubernetes distribution for IoT & edge.',
  ...
  [
    'microk8s',
    'MicroK8s',
    'Small, fast, single-package Kubernetes by Canonical.',
  ...
  [
    'headlamp',
    'Headlamp',
    'Kubernetes dashboard focused on extensibility.',
  ...
  [
    'forgejo',
    'Forgejo',
    'Self-hostable Git forge, soft-fork of Gitea.',
    'https://github.com/forgejo/forgejo',
  ],
  ['gitea', 'Gitea', 'Lightweight self-hosted Git service.', 'https://github.com/go-gitea/gitea'],
  [
    'woodpecker-ci',
    'Woodpecker CI',
    'Community fork of Drone, container-native CI.',
  ...
  [
    'curlie',
    'curlie',
    'Frontend to `curl` that adds the ease of `httpie`.',
    'https://github.com/rs/curlie',
  ],
  [
    'mitmproxy',
    'mitmproxy',
    'Interactive HTTPS proxy for pentesters.',
    'https://github.com/mitmproxy/mitmproxy',
  ],
  [
    'brook',
    'Brook',
    'Cross-platform proxy/VPN software, with multiple protocols.',
    'https://github.com/txthinking/brook',
  ],
  [
    'clash-cli',
    'clash-cli',
    'Tiny CLI for Clash (PuerTee variant).',
    'https://github.com/SukkaW/clash-cli',
  ],
  [
    'proxychains-ng',
    'proxychains-ng',
    'Hook libc network APIs to route through a SOCKS/HTTP proxy.',
    'https://github.com/rofl0r/proxychains-ng',
  ],
  [
    'tun2socks',
    'tun2socks',
    'Convert a TUN device input to a SOCKS proxy.',
    'https://github.com/xjasonlyu/tun2socks',
  ],
  [
    'heirloom-ng',
    'heirloom-ng',
    "Fork of the Heirloom Project's utilities (telnet, netcat, etc).",
    'https://github.com/gheift/heirloom-ng',
  ],
  [
    'magic-wormhole',
    'magic-wormhole',
  ...
  [
    'rclone',
    'rclone',
    'Cloud storage sync for many providers.',
  ...
  [
    'scrcpy',
    'scrcpy',
    'Display and control Android devices from the desktop.',
    'https://github.com/Genymobile/scrcpy',
  ],
  [
    'croc',
    'croc',
    'Securely send things between computers, end-to-end encrypted.',
  ...
  [
    'homeproxy',
    'HomeProxy',
    'Transparent proxy on OpenWrt, based on sing-box.',
    'https://github.com/immortalwrt/homeproxy',
  ],
  [
    'openwrt-actions',
    'OpenWrt Actions',
    'Build OpenWrt firmware in GitHub Actions.',
    'https://github.com/ophub/amlogic-s9xxx-openwrt',
  ],
  [
    'immortalwrt',
    'ImmortalWrt',
    'OpenWrt fork with more packages and newer kernels.',
    'https://github.com/immortalwrt/immortalwrt',
  ],
  [
    'luci-app-ssr-plus',
    'luci-app-ssr-plus',
    'SSR / SS / V2Ray / Xray / Trojan / Brook GUI on OpenWrt.',
